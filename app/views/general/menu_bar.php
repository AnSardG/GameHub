...
<div class="menu-bar">
    ...
    <div class="container">
        <div class="row">
            <div class="col-3">
                <a href="/">
                    <img id="home-icon" src="public/img/home_icon.png" alt="Home">
                </a>
            </div>
            <div class="col-3">
            ...
            <div class="col-3">
                <a href="/?favorites=true">
                    <img id="favorite-icon" src="public/img/favorites_icon.png" alt="Favorite Games">
                </a>                
            </div>
            <div class="col-3">
                <a href="/?logout=true">
                    <img src="public/img/logout_icon.png" alt="Login or Register">
                </a>
            </div>
        </div>
    </div>
